  ...
  return (
    <Layout>
      ...
      <p style={paragraphStyle}>
        Welcome to my blog...It's powered by <a href="https://gatsbyjs.com">gatsby</a> so you know it is great! 
	...
	<li><a href="https://florianedemessi.wordpress.com">wordpress</a></li>
      ...
      <li><a href="https://dev.nairolf32.com/zer0ne">zer0ne</a>: My Cybersecurity blog</li>
        ...
        writer and what I am doing here is mostly trying to share what I learn and learn technical writing
        by doing so. I am quite open to constructive feedback so feel free to contact me if you have any
        suggestions or if you find any mistakes. Also I am a somewhat busy guy so never expect consistency
        in my writing schedule (this is a freestyle! kek)
      </p>
      
      <Link to={'/posts'}>All posts/articles are here</Link>
